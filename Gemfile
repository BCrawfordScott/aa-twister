...
group :development, :test do
  # These are only for dev land!
  # Call 'byebug' anywhere in the code to stop execution and get a  console
  gem 'byebug', platforms: [:mri, :mingw, :x64_mingw]

  gem 'better_errors' # nicely formatted errors during development
  gem 'binding_of_caller' # lets us poke around our code at the spot of an error
...
group :test do
  ...
  # gem 'capybara' # Specifically for integration testing
